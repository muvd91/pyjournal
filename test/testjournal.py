...
class TestJournal(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.e1 = Entry({'_id': '1', 'timestamp': self.t1,
                         'content': '', 'category': '', 'tags': []})
        self.e2 = Entry({'_id': '1', 'timestamp': self.t2,
                         'content': '', 'category': '', 'tags': []})
        self.e3 = Entry({'_id': '1', 'timestamp': self.t3,
                         'content': '', 'category': '', 'tags': []})
        self.e4 = Entry({'_id': '1', 'timestamp': self.t4,
                         'content': '', 'category': '', 'tags': []})

    def test_get_day_list(self):
        entry_list = list()
        entry_list.append(Entry(
            {'_id': '1', 'timestamp': self.t1, 'content': '', 'category': '', 'tags': []}))
        entry_list.append(Entry(
            {'_id': '1', 'timestamp': self.t2, 'content': '', 'category': '', 'tags': []}))
        entry_list.append(Entry(
            {'_id': '1', 'timestamp': self.t3, 'content': '', 'category': '', 'tags': []}))
        entry_list.append(Entry(
            {'_id': '1', 'timestamp': self.t4, 'content': '', 'category': '', 'tags': []}))
